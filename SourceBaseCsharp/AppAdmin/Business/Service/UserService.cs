...
namespace AppAdmin.Business.Service
{
    public class UserService : BaseService
    {
        ...
        public UserService(IHttpClientFactory httpClientFactory, IConfiguration configuration, SecureLocalStorageHandler secureLocalStorage, AuthenticationStateProvider authenticationStateProvider) : base(httpClientFactory, configuration)
        {
